...
function CheckoutSessionCard({ session, onOpenManualOrder }: { session: CheckoutSession; onOpenManualOrder?: (session: CheckoutSession) => void }) {
    ...
    const handleCompleteCheckout = () => {
        if (onOpenManualOrder) {
            ...
            // Fallback: mostrar mensaje si no se proporcionó la función
            ...
            >
                ...
                <div className="flex flex-col items-end gap-1">
                    ...
                    <button
                        ...
                        className="bg-blue-500 hover:bg-blue-600 text-white text-xs font-bold px-3 py-1.5 rounded-lg transition-all active:scale-95 shadow-sm"
